    ...
    <div className='contaner px-5'>
      <div className='row text-start UC text-muted px-5  py-3'>
        ...
        <div className='col-md-6 col-12 py-5'>
          <h3 className="pb-3">Charges explained</h3>
          ...
          <h6> Call & trade </h6>
          <p></p>Additional charges of ₹50 per order for orders placed through a
        ...
        <div className='col-md-6 col-12 py-md-5'>
          <h6 className="pt-md-5">GST</h6>
