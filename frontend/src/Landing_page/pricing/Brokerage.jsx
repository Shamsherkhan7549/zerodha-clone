  ...
  return (
    <div className='container '>
        <div className="row text-center">
            ...
            <div className="col-md-4 col-12  p-3">
            <img className='w-100' src="/images/pricingMF.svg" alt="" />
